...
export type FeaturedItemsQueryQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type FeaturedItemsQueryQuery = {
  collections: {
    edges: Array<{
...
export type CollectionsQueryQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;
...
export type CollectionsQueryQuery = {
  collections: {
    edges: Array<{
      ...
      > & {
        image?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.Image, 'altText' | 'width' | 'url'>
        >;
      };
    }>;
  };
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query featuredItemsQuery {\n    collections(first: 10, query: "Featured") {\n      edges {\n        node {\n          id\n          title        \n          handle\n          image {\n            altText\n            width\n            height\n            url(transform: {maxWidth: 400})\n          }\n        }\n      }\n    }\n  }\n  ': {
    return: FeaturedItemsQueryQuery;
    variables: FeaturedItemsQueryQueryVariables;
  };
  '#graphql\n  query CollectionsQuery {\n    collections(first: 3, sortKey: ID) {\n      edges {\n        node {\n          id\n          title\n          description\n          handle\n          image {\n            altText\n            width\n            url(transform: {maxWidth: 400})\n          }\n        }\n      }\n    }\n  }\n  ': {
    return: CollectionsQueryQuery;
